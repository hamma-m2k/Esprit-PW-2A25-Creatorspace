<?php
// /view/backoffice/produits/form_edit.php
// No business logic — display only. $item pre-filled from controller.
include __DIR__ . '/../layout/header.php';
?>

<div class="page-header">
  <div>
    <div class="page-title">Modifier le produit</div>
...
<div style="max-width:580px;">
  <div class="card">
    ...
    <!-- POST → action=update&id= — NO HTML5 validation -->
    <form method="POST" action="index.php?controller=produit&action=update&id=<?= (int)$item['id'] ?>">
      ...
      <textarea name="description" rows="3" placeholder="Description du produit…"
                style="width:100%;background:#f5f7fa;border:1px solid #e8e8e8;
                       border-radius:8px;padding:11px 14px;font-size:14px;
                       margin-bottom:16px;outline:none;resize:vertical;"><?= htmlspecialchars($item['description'] ?? '') ?></textarea>
