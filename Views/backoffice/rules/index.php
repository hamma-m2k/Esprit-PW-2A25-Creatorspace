<?php $pageTitle = 'Rules'; $pageSubtitle = 'Toutes les règles (jointure contrats)'; ?>
...
<div class="card">
  <div class="card-header">
    ...
    <div style="display:flex;gap:10px;">
      <a href="<?= BASE_URL ?>/rules/create"   class="btn btn-outline btn-sm">＋ Ajouter une rule</a>
      <a href="<?= BASE_URL ?>/rules/add"      class="btn btn-primary btn-sm">◆ Ajout / Import</a>
    </div>
  </div>
  ...
  <div class="filters">
    ...
    <a href="<?= BASE_URL ?>/rules" class="filter-btn active">Tous</a>
  ...
  <div class="empty-state">
    ...
    <p style="margin-top:12px;">
      <a href="<?= BASE_URL ?>/rules/add" class="btn btn-primary btn-sm">Ajouter des rules</a>
    </p>
  </div>
  <?php else: ?>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="<?= BASE_URL ?>/contrats/show/<?= $r['contrat_id'] ?>"
          ...
          <td>
            <div class="actions">
              <a href="<?= BASE_URL ?>/rules/edit/<?= $r['id'] ?>"
