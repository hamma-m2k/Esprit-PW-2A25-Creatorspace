<?php $pageTitle = 'Contrats'; $pageSubtitle = 'Gestion des contrats'; ?>
...
<div class="card">
  <div class="card-header">
    ...
    <a href="<?= BASE_URL ?>/contrats/create" class="btn btn-primary btn-sm">＋ Nouveau contrat</a>
  </div>

  <!-- Filtres -->
  <div class="filters">
    <a href="<?= BASE_URL ?>/contrats" class="filter-btn active">Tous</a>
  ...
  <div class="empty-state">
    ...
    <p style="margin-top:12px;">
      <a href="<?= BASE_URL ?>/contrats/create" class="btn btn-primary btn-sm">Créer le premier contrat</a>
    </p>
  </div>
  <?php else: ?>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="<?= BASE_URL ?>/contrats/show/<?= $c['id'] ?>"
          ...
          <td>
            <div class="actions">
              ...
              <a href="<?= BASE_URL ?>/contrats/edit/<?= $c['id'] ?>"
                 class="btn btn-outline btn-sm btn-icon" title="Modifier">✎</a>
              <a href="<?= BASE_URL ?>/rules/add?contrat_id=<?= $c['id'] ?>"
                 class="btn btn-primary btn-sm btn-icon" title="Ajouter rules">◆</a>
              <form method="POST" action="<?= BASE_URL ?>/contrats/delete/<?= $c['id'] ?>"
...
<?php if (isset($pagination)) echo $pagination->render(BASE_URL . '/contrats'); ?>
